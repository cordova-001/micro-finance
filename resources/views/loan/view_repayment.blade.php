                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title"> Loan Repayment</h3>
                                        </div>
                                        <div class="nk-block-head-content">
                                                ...
                                                <tbody>
                                                    @foreach ($allLoans as $allLoan)
                                                        <tr>
                                                            ...
                                                            <td>{{ $allLoan->first_name }} {{ $allLoan->last_name }}</td>
                                                            <td>{{ $allLoan->paid_amount }}</td>
                                                            
                                                            <td>{{ $allLoan->paid_date }}</td>
                                                            <td>{{ $allLoan->collected_by }}</td>
                                                            <td>{{ $allLoan->payment_means }}</td>
