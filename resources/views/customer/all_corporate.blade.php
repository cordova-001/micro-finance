                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title"> Corporate Account Management</h3>
                                        </div>
                                        <div class="nk-block-head-content">
                                                                    ...
                                                                    <div class='drodown'>
                                                                        ...
                                                                        <form method='get'>
                                                                            <ul class='link-list-opt no-bdr'>
                                                                                <li class="form-control"><span><a href=""><em class='icon ni ni-eye'></em> Customer Profile</a> </span></li>
                                                                                <li class="form-control"><span><a href=""><em class='icon ni ni-eye'></em> Edit Customer</a> </span></li>
                                                                                <li class="form-control"><span><a href=""><em class='icon ni ni-eye'></em>  Transaction History</a> </span></li>
